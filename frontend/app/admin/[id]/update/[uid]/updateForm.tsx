...
export default function SignupForm({ uid }: { uid: number }) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            userData.append("activation", "true");
            userData.append("ban", "false");

            const response = await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/admin/updateFullAdmin/${uid}`, userData, { withCredentials: true } );
